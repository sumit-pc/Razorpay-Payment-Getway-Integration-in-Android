package com.sumit.razorpaypaymentgetway;
...
public class MainActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    public void startPayment() {
        ...
        try {
            ...
            options.put("name", "Sumit Powers pvt ltd");
            options.put("description", "Goods Payment");
            //You can omit the image option to fetch the image from dashboard
            options.put("image", "https://rzp-mobile.s3.amazonaws.com/images/rzp.png");
            options.put("currency", "INR");
            String payment = orderamount.getText().toString();
            //options.put("order_id", "order_FDd0CxAe12absE");
...
//            preFill.put("email", "sumit.pc@rediffmail.com");
//            preFill.put("contact", "8007840200");
//
